...
#
# Requirements:
# - The function should prompt the user to enter a letter (a-z or A-Z) and determine
#   its type.
...
#
# Write a Python function named `check_voting_eligibility` that determines if a user
...
# - Use `int()` to convert the input to an integer. Ensure to handle any conversion
#   errors gracefully.
...
#
# Write a Python function named `calculate_dog_years` that calculates a dog's age in
# dog years.
...
# - Apply conditional logic to perform the correct age calculation based on the dog's
#   age.
...
#
# Write a Python script named `weather_advice` that provides clothing advice based on
# weather conditions.
#
# Requirements:
...
#
# Hints:
# - Use logical operators (`AND`, `OR`, `NOT`) in your if statements to handle multiple
#   conditions.
...
#
# Write a Python function named `determine_season` that figures out the season based on
# the entered date.
#
# Requirements:
# - The function should first prompt the user to enter the month (as three characters):
#   "Enter the month of the year (Jan - Dec):"
# - Then, the function should prompt the user to enter the day of the month: "Enter the
#   day of the month:"
